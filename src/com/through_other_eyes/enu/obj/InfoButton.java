...
public class InfoButton extends Button{
    ...
    public InfoButton(Point position, File elementImage) throws IOException {
        super(position, elementImage);
    }

    public InfoButton(File elementImage, GameCore.Align align, int offset, int y) throws IOException {
