...
public class MainMenuButton extends Button{
    ...
    public MainMenuButton(Point position, File elementImage) throws IOException {
        super(position, elementImage);
    }

    public MainMenuButton(File elementImage, GameCore.Align align, int offset, int y) throws IOException {
